...
- Extend the handoff package builder pattern to future external reports. Current handoff package and archive validation now check the third-party HTML artifact manifest contract and unsafe payload strings, instead of only checking file presence and SHA256.
