...
- PP-StructureV3 uses PP-OCRv6 through explicit `PP-OCRv6_medium_det` and `PP-OCRv6_medium_rec` model names. Do not set `ocr_version=PP-OCRv6`; the current PP-StructureV3 constructor still only accepts OCR version aliases up to PP-OCRv5.
