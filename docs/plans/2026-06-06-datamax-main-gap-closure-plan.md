...
- for enrichment enqueue, prove `missing_fingerprint_count=0` and no `local_file_not_found` fingerprint coverage blocker for the reviewed scope before any real run;
