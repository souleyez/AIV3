...
1. 先关闭当前 P5 `workflow_task_view_support` 切片：补齐单独提交；若发布到 8 服务器，则按 P0 code deploy 边界跑远端 build、restart、health/ready 和 P0 smoke。
