...
| 项 | 当前口径 | 执行要求 |
| --- | --- | --- |
| GitHub 功能基线 | 以 `git log -1` 为准；M6BO 收版后最新功能基线包含 public candidate revalidation receipt | 对外说“已完成”时必须引用已推送 commit 或当次验证，不能把工作区草稿说成已上线 |
