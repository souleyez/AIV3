...
| 顺序 | 当前项 | 状态 | 下一步 | 关闭标准 |
| --- | --- | --- | --- | --- |
| 1 | P5 memory directory view helper 拆分 | 本地代码、格式、定向 Rust 回归、Web build、P0 smoke 和 prewarm observability self-test 已通过。 | 提交、推送 GitHub，并按 P0 code deploy 边界同步 8 服务器。 | `memory_directory_view_support` 模块单测、旧 memory directory view 回归、`cargo check`、Web build、P0 smoke、8 服务器 release build、health/ready 和服务 active 全通过；不改变第三方公开契约。 |
...
1. 先收口当前 P5 memory directory view helper 切片：提交、推送、8 服务器 code deploy、私有 smoke、validation 写回。
