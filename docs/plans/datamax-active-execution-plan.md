...
| 2 | P5 external bot message parse orchestration 拆分 | 待处理。 | 如果没有 P1 凭证、P2/P4 写入确认或新客户失败样例，下一步评估 `parse_external_bot_message_payload` 周边 orchestration/normalization 的进一步行为保持拆分。 | 有清晰模块边界、聚焦测试和 P0 smoke；不改变第三方公开契约。 |
