...
P1-12A: NewBai customer-answer 离线 evaluator 已补；下一步需用受控 provider/live result JSONL 补真实最终答案质量 receipt
P1-12B: 真实答案 receipt 通过后，再评审已有模板绑定/页面复用守卫是否需要 Rust 侧硬门禁
