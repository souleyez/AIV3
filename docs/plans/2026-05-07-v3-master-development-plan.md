...
17. Add failure handling for unsupported source, unavailable video, resolver blocked, parse partial, provider failure, frame extraction failure, no slide rectangle found, subtitle OCR low confidence, and low-confidence extraction.
