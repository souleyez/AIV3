...
- Missing: persisted published-version history beyond the generated artifact workspace, stronger visual rectangle detection/crop replacement beyond simple background contrast, richer PPTX/Markdown rendering, and model-authored completion turn wiring after background extraction.
