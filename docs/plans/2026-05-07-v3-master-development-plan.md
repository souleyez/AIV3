...
2026-05-25 plan consolidation: parsing quality, answer quality, queryable facts, Codex executor boundaries, data-ingestion analysis, and static-page productization now have one active plan at `docs/plans/2026-05-25-v3-mainline-quality-executor-plan.md`. Keep this master document as historical context and high-level feature background. Do not change third-party public interfaces without an explicit operator decision.
...
- `docs/plans/2026-05-25-v3-mainline-quality-executor-plan.md`: active consolidated mainline plan for parser quality, document understanding, retrieval/fact supply, answer reliability, static-page generation, data-ingestion analysis, and Codex executor boundaries.
...
- **Active mainline thread:** run `docs/plans/2026-05-25-v3-mainline-quality-executor-plan.md` only. It owns parsing quality, PaddleOCR/MiniMax fallback, document structure/entity/term extraction, queryable fact supply, retrieval/evidence quality, answer reliability, static-page generation, data-ingestion analysis, and Codex executor boundaries.
