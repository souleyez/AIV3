...
- Missing: persisted published-version history beyond the generated artifact workspace, higher-confidence visual rectangle detection/crop replacement beyond border-background contrast, richer PPTX/Markdown rendering, and model-authored completion turn wiring after background extraction.
