...
- Missing: durable final-deliverable publication/download lifecycle, richer PPTX/Markdown rendering, and richer AssistantRun follow-up that can notify the model/user when background extraction has completed.
