...
`validate:delivery` verifies `<package>.delivery-manifest.json` against the sibling package directory, package manifest, archive, `.sha256` sidecar, release JSON report, and release Markdown summary.
