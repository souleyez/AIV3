...
- 该能力只面向视频里已经播放 PPT/课件的内容，不负责把普通视频创作成 PPT。微信视频号、扫码登录、cookie、私有平台页或需要登录态的来源不属于自动解析范围；系统不会声称已经看过这类视频或已经生成 PPT。请改为上传视频文件、提供可匿名下载的直连视频 URL，或申请 operator 授权录屏处理。
