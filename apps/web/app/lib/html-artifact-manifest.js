...
const VIDEO_ARTIFACT_KIND_LABELS = {
  ...
  ppt_outline: 'PPT 大纲',
  slide_quality_report: '质量报告',
  slide_notes: '讲稿备注',
  video_slides_markdown: 'Markdown 讲义',
...
const VIDEO_FOLLOW_UP_ACTION_LABELS = {
  ...
  review_published_deliverable_manifest: '复核发布清单',
  review_published_version_history: '复核版本历史',
  review_extraction_artifacts_manifest: '复核产物索引',
  review_slide_notes: '复核讲稿备注',
  review_video_slides_markdown: '复核 Markdown 讲义',
  ...
  review_contact_sheet_or_promote_rectangle_extraction: '复核联系表或补齐矩形提取',
  review_slide_dedupe_manifest: '复核重复页去重结果',
  persist_video_published_version: '持久化发布版本',
...
function renderVideoExtractionSummary(manifest) {
  ...
  return `
    ${renderKeyValueGrid([
      ...
      { label: 'Markdown 讲义', value: deliverableStatus.hasVideoSlidesMarkdown || deliverableStatus.has_video_slides_markdown ? 'ready' : 'not ready' },
