...
const pureGuideProfile = {
  ...
  title: 'DataMax 纯第三方简单版接口文档',
  brandCode: 'DataMax / PURE THIRD PARTY',
  brandTitle: '纯第三方简单版',
  brandDescription: '自建页面、文档库、用户 ID、会话 ID、skill、模板、产物与业务动作的接口说明。',
  heroTitle: 'DataMax 纯第三方简单版接口文档',
...
const fullGuideProfile = {
  ...
  title: 'DataMax 第三方完整对接文档',
  brandCode: 'DataMax / THIRD PARTY API',
  brandTitle: '完整对接文档',
  brandDescription: '标准机器人、纯第三方、文档、用户标识、产物、动作、观测和交接清单的完整接口说明。',
  heroTitle: 'DataMax 第三方完整对接文档',
...
function renderArchitectureDiagram() {
  const steps = [
    ...
    ['DataMax 对外接入网关', '校验连接、幂等、通道策略'],
    ['第三方文档库', '按文档 ID 和版本获取证据'],
    ['DataMax 助手运行时', '按本轮范围供料给模型'],
