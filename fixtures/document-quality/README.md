...
Aliases accepted by the wrapper include `low_text_pdf_final`, `deng_engineer`, `resume_company_stats`, `resume_ranking_table`, `attendance_final`, `smart_home`, and `smart_elevator`.
